...
function init() {
  ...
  d3.json("/names").then((sampleNames) => {
    ...
    buildMetadata(Cces.GunBackgroundChecks_16);                 // temp hard coded to Gun BackgroundChecks_16 for trouble shooting
    sample_metadatatotals(Cces.GunBackgroundChecks_16);
    Metadata_States(Cces.GunBackgroundChecks_16);
  });
}
...
function optionChanged(newSample) {
  ...
  sample_metadatatotals(newSample)
  Metadata_States(newSample)
}
